              ...
              <div className="col-xl-6">
                <div className={styles.left}>
                  ...
                  <h2 className="head mx-0">
                    Build your <p className="head-2">success</p> with{" "}
                    <p className="head-1">E-Learning</p>
                  </h2>
                  <p className="lead mb-3">
                    We are providing high-quality online courses to improve your
                    skill. Our all instructors are highly experienced and
                    experts on self fields.
                  </p>
                  <Link style={{ textAlign: "center" }} to="/courses">
                    <button className="custom-b">View Our Courses</button>
                  </Link>
                </div>
              </div>
              <div className="col-xl-6">
