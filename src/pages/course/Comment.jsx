...
<<<<<<< HEAD:src/pages/course/Comment.jsx
...
=======
export default function Comment({ courseId }) {
    const [term, setTerm] = useState("");
    const [term2, setTerm2] = useState("");
    const [show, setShow] = useState(null);
    const [edit, setEdit] = useState(null);
...
>>>>>>> shSalman009-patch-1:src/components/SingleCourse/Comment.jsx
}
